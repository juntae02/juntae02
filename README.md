...
**[프로젝트 개요]**
> ***선물의 종류는 많지만 감정은 없다***는 문제의식에서 출발했습니다.  
> 선물의 ***목적과 기간***에 적합한 꽃을 추천하고, 재배 과정에서 음성을 기록하여 ***진심***을 전할 수 있습니다.
> 또한, ***재배 실패***에 대한 부담을, 로봇 팔 기반의 자동화 시스템으로 해결했습니다.
>> - 꽃 추천, 씨앗 심기 및 YOLO 모델 생성(***Me***)  
>> - 전체 시나리오 관리 및 기능 모듈화(석환)  
>> - 포장, 자동급수 및 기능 모듈화(예은)  
>> - 음성 메시지 기록 및 Front-end(요한)  

**[담당 역할]**
> 상황별 꽃 추천 및 씨앗 심기 기능 구현, 
>> - ***OpenAI API***를 활용하여, 상황별 꽃 추천 기능 
>> - ***두산 로봇팔***을 사용하여, 씨앗 심기 기능
